...
if (!alive) return;
  ...
  /* ══════════════════════════════════════════════════════════════════ */
  // overflow-x is CLIP, not hidden: `hidden` would turn this into a scroll
  // container, which changes how fixed children behave; `clip` trims the same
  // horizontal overflow without that.
  return (
